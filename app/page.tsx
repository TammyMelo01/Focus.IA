...
const example =
  "Tenho que responder clientes, organizar documentos, montar uma proposta, revisar pendencias e separar pausas porque costumo hiperfocar e esquecer do tempo.";
      ...
      <section className="hero">
        <div className="hero-copy">
          <div className="eyebrow">
            <Brain size={18} /> Assistente de função executiva com IA
          </div>
        ...
        <div className="hero-card">
          <div className="stat">
            <TimerReset /> Pausas anti-hiperfoco
          </div>
          <div className="stat">
            <CalendarClock /> Agenda com microblocos
          </div>
          <div className="stat">
            <ShieldCheck /> Menos sobrecarga mental
          </div>
        </div>
      </section>
